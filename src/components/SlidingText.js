...
const SlidingText = (props) => {
  ...
  return (
    <Fade delay={500} duration={3000}>
      <div className="select-none -translate-y-2 relative text-rose-500 font-semibold md:text-8xl text-4xl tracking-wider overflow-hidden p-4 w-full h-12 md:h-28 justify-center items-center">
        {textsState.map((text) => (
          <div
            key={text.id}
